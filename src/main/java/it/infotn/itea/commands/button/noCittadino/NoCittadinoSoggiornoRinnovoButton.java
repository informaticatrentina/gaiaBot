...
public class NoCittadinoSoggiornoRinnovoButton extends CommandsButton {

    public NoCittadinoSoggiornoRinnovoButton(Update update) {
        this.update = update;
    }
