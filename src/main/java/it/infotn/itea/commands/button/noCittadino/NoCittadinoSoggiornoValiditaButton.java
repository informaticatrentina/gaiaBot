...
public class NoCittadinoSoggiornoValiditaButton extends CommandsButton {

    public NoCittadinoSoggiornoValiditaButton(Update update) {
        this.update = update;
    }
