...
public class SiCittadinoLavAutButton extends CommandsButton {

    public SiCittadinoLavAutButton(Update update) {
        this.update = update;
    }
