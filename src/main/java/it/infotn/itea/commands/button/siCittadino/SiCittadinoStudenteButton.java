...
public class SiCittadinoStudenteButton extends CommandsButton {

    public SiCittadinoStudenteButton(Update update) {
        this.update = update;
    }
