...
public class NoCittadinoSoggiornoRicongiungimentoButton extends CommandsButton {

    public NoCittadinoSoggiornoRicongiungimentoButton(Update update) {
        this.update = update;
    }
    ...
    public PartialBotApiMethod<Message> esegui(ContextBot context) {
        ...
        sendMessage.setText(context.messageBundleBuilder.getMessage("testo.docAllegare") + " \n " + context.messageBundleBuilder.getMessage("testo.NO_EU.soggiorno.ricongiungimento"));
