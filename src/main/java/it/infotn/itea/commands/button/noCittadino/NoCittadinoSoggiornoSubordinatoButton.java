...
public class NoCittadinoSoggiornoSubordinatoButton extends CommandsButton {

    public NoCittadinoSoggiornoSubordinatoButton(Update update) {
        this.update = update;
    }
