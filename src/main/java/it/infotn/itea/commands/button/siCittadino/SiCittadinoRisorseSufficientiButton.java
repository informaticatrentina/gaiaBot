...
public class SiCittadinoRisorseSufficientiButton extends CommandsButton {

    public SiCittadinoRisorseSufficientiButton(Update update) {
        this.update = update;
    }
