...
public class SiCittadinoFamigliareButton extends CommandsButton {

    public SiCittadinoFamigliareButton(Update update) {
        this.update = update;
    }
